        ...
        <div id="form-border" class="comment-respond form-border" style="background : #fff">
            ...
            <section id="section-categories" class="section check-my-ticket-section">
                ...
                <div>
                    ...
                    {!! html()->text('email_address', null)->class('form-control mb-3') !!}
                    {!! html()->label(Lang::get('lang.ticket_number'), 'ticket_number') !!}<span class="text-red"> *</span>
                    {!! html()->text('ticket_number', null)->class('form-control mb-3') !!}
            ...
            <div id="form-border" class="comment-respond form-border" style="background : #fff">
                ...
                <section id="section-categories">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-2 mb-3 {{ Session::has('country_code_error') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-5 mb-3 {{ $errors->has('mobile') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-5 mb-3 {{ $errors->has('Phone') ? 'has-error' : '' }}">
                       ...
                       @endif
                        <div class="col-md-12 mb-3 {{ $errors->has('help_topic') ? 'has-error' : '' }}">
...
//                            ?><!---->
                        ...
                        <div class="col-md-12 mb-3 {{ $errors->has('Details') ? 'has-error' : '' }}">
