...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <a href="{{url('ticket/print/'.$ticket->id)}}" target="_blank" class="btn btn-default"><i class="fa fa-print text-primary"> </i> Print</a>
            <div class="btn-group">
...
$data = $ConvDate[0];
	...
	?>
                            ...
                            <li>
                                ...
                                <i class="fa fa-tag text-bg-purple" title="Posted by System"></i>
