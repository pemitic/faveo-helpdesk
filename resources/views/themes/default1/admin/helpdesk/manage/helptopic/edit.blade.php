...
@section('content')
<!-- open a form -->
{!! html()->modelForm($topics, 'PATCH', url('helptopic/'.$topics->id))->open() !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('parent_topic') ? 'has-error' : '' }}">
                    ...
                    {!! html()->select('parent_topic', [''=>Lang::get('lang.select_a_parent_topic'),Lang::get('lang.help_topic')=>$topics->pluck('topic','id')->toArray()], null)->class('form-control') !!}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('custom_form') ? 'has-error' : '' }}">
                    ...
                    {!! html()->select('custom_form', [''=>Lang::get('lang.select_a_form'),Lang::get('lang.custom_form')=>$forms->pluck('formname','id')->toArray()], null)->class('form-control') !!}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                    ...
                    {!! html()->select('department', [''=>Lang::get('lang.select_a_department'),Lang::get('lang.departments')=>$departments->pluck('name','id')->toArray()], null)->class('form-control') !!}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('sla_plan') ? 'has-error' : '' }}">
                    ...
                    {!! html()->select('sla_plan', [''=>Lang::get('lang.select_a_sla_plan'),Lang::get('lang.sla_plans')=>$slas->pluck('name','id')->toArray()], null)->class('form-control') !!}
                </div>
            </div>
