...
@section('content')
	{!! html()->modelForm($footer, 'PATCH', url('post-create-footer/'.$footer->id))->acceptsFiles()->open() !!}
<!-- <div class="form-group {{ $errors->has('company_name') ? 'has-error' : '' }}"> -->
	<!-- table  -->
<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">{{Lang::get('lang.footer1')}}</h3>  {!! html()->submit(Lang::get('lang.save'))->class('form-group btn btn-primary pull-right') !!}
    </div>
